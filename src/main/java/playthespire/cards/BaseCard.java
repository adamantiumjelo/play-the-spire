package playthespire.cards;

import basemod.BaseMod;
import basemod.abstracts.CustomCard;
import basemod.abstracts.DynamicVariable;
import playthespire.PlayTheSpire;
import playthespire.util.CardStats;
import playthespire.util.TriFunction;
...
import static playthespire.util.GeneralUtils.removePrefix;
import static playthespire.util.TextureLoader.getCardTextureString;


public abstract class BaseCard extends CustomCard {
    final private static Map<String, DynamicVariable> customVars = new HashMap<>();

    protected static String makeID(String name) { return PlayTheSpire.makeID(name); }
    ...
    public void upgrade()
    {
        if (!upgraded)
        {
            ...
            if (this.upgradesDescription)
            {
                ...
                {
                    PlayTheSpire.logger.error("Card " + cardID + " upgrades description and has null upgrade description.");
                }
                else
                {
